...
# change parameters in get_docs_from_mongo to get the right documents
#change prompt in generate_completion to get the right prompt
# make sure environment variables are set to the right values
...
UNPROCESSED_DIRECTORY = '/Users/marynelson/docs/ucf_catalog'
DOCUMENT_DIRECTORY = '/Users/marynelson/docs/ucf_catalog/processed'
VISITED_LOG = '/Users/marynelson/docs/ucf_catalog/processed/visited.txt'
REJECTED_LOG = '/Users/marynelson/docs/ucf_catalog/processed/rejected.txtp'
...
if __name__ == "__main__":
    ...
    asyncio.run(loader.chunked_files())
    _mongo_conn.close()
