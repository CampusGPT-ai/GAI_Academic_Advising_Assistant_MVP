...
class SearchRetriever:
    ...
    def retrieve_content(self,query: str,n=3 ) -> list:
        results, questions, followups = self.search_client.simple_search(query,'content_vector',n)
        return results, questions, followups
    ...
    def generate_questions(self, user_info):
         ...
         content, qs, fus = self.retrieve_content(search_string,n=10)
